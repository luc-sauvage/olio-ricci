        ...
        <>
                    ...
                    <div className="column-container">
                        <div className="column left-col">
                            ...
                            <p className="col-text">
                                ...
                                Ricci. Il primo, nell’anno di nascita vince
                                subito il Silver Prize alla competizione Japan
                                Olive Oil Prize, e insieme al
                            </p>
                        </div>
                        <div className="column right-col">
                            <p className="col-text">
                                secondo si piazza fisso nelle classifiche dei
                                migliori olii Slow Food. Ma il desiderio di
                                innovare spinge ancora la famiglia Ricci a
                                concepire nuovi prodotti, come il Condimento al
                                Melangolo, un extravergine di oliva lavorato con
                                melangoli freschi(Citrus X Aurantium). L’olio
                                extravergine di oliva Ricci non è semplice olio,
                                ma al suo interno si ritrovano la tradizione e
                                la dedizione umbre nella lavorazione della terra
                                e nella capacità di coglierne i suoi frutti. Un
                                legame indissolubile tra i colli di Montecchio e
                                la storia familiare. Si narra che l’assenza del
            ...
            <section id="prodotti" className="content-section">
                <div className="content-container">
                    ...
                    <p className="col-text">
                        L’olio extravergine d’oliva Ricci è coltivato ad un
                        altitudine di 500 mt a pochi metri dal Frantoio Ricci.
                        Questa è una delle caratteristiche principali che ne
                        garantisce, grazie alla rapidità di conferimento delle
                        olive e l’immediata lavorazione, il mantenimento di
                        tutte le caratteristiche organolettiche, dalla
                        freschezza ai profumi, dal sapore al colore. Abbiamo
                        deciso di seguire il difficile sentiero dell’impegno,
                        della serietà e della tradizione perché siamo convinti
                        che oggi sia l’unico modo per riuscire ad instaurare un
                        corretto, trasparente e duraturo rapporto di fiducia con
                        i nostri clienti.
                    </p>
                    <img
                ...
                <div className="product-container">
                    ...
                    <div className="right-col shrink flex-col flex-align-left-col">
                        ...
                        <p className="col-text">
                            BLEND: Moraiolo, Frantoio, Leccino COLORE: dal verde
                            pistacchio al giallo oro. OLFATTO: al naso si apre
                            con note vegetali di cardo ed erba tagliata. GUSTO:
                            è coerente con le sensazioni olfattive, morbido ed
                            avvolgente, armonico ed equilibrato nelle note amare
                            e piccanti.
                        </p>
                ...
                <div className="product-container">
                    <div className="left-col shrink flex-col flex-align-right-col">
                        ...
                        <p className="col-text">
                            Il Monocultivar Moraiolo ricci al naso mette in
                            rilievo note mediamente intense di carciofo poi in
                            bocca mostra un corpo adeguato, un buon equilibrio
                            delle componenti amaro-piccanti e un’aromaticità che
                            verte sulla percezione di erbe amare e di cardo.
                        </p>
                        <button className="button big">Acquista</button>
                    </div>
                    <img
                ...
                <div className="product-container">
                    ...
                    <div className="right-col shrink flex-col flex-align-left-col">
                        ...
                        <p className="col-text">
                            Di buona intensità al naso il Monocultivar Frantoio
                            Ricci offre netti sentori di fiori campestri e di
                            mandorla verde. In bocca mostra un corpo pieno,
                            mentre il gusto poggia su lieve amaro e su un
                            piccante mediamente intenso e progressivo arricchito
                            da persistente sapore di mandorla.
                        </p>
                        <button className="button big">Acquista</button>
                    </div>
                </div>
                <div className="product-container">
                    <div className="left-col shrink flex-col flex-align-right-col">
                        ...
                        <p className="col-text">
                            Olive di varietà Frantoio, pigiate con melangoli
                            freschi (Citrus X Aurantium), una varietà di arancia
                            che cresce nel sud dell'Umbria, la nostra regione.
                            Ha un alto contenuto di polifenoli e un sapore
